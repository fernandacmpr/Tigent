...
const nouser = () => {navigation.navigate('NoUser')}
    ...
    <View style={{width,height}}>
     ...
     <Image style={{width:"60%",height:"22%"}}source={require('../assets/tigentLogo.png')}/>
      ...
      >
        ...
        <TouchableOpacity onPress={nouser}>
          <Text style={{marginTop:50,fontSize:20,fontFamily:"Mulish_500Medium",color:"#FF3E89"}}>Enter without logging in</Text>
        </TouchableOpacity>
