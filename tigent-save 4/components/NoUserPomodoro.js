...
const hp = () => {navigation.navigate("NoUser")}
const dashboard = () => {navigation.navigate('NoUserDashboard')}
const brea = () => {navigation.navigate("NoUserBreak")}
  const [isTimerStart, setIsTimerStart] = useState(false);
  const [timerDuration, setTimerDuration] = useState(1500000);
  ...
  return (
    ...
    fontFamily:"Mulish_500Medium"}}>
         ...
         <Timer
            ...
            options={options}
            handleFinish={() => {
              alert("Congrats, you've worked for 25 minutes! You can take a break now.");
            }}
          ...
          <Text style={{marginBottom:10,marginTop:50,fontFamily:"Mulish_500Medium",color:"white",fontSize:30,alignSelf:"center"}}>Break</Text>

          <TouchableOpacity onPress={brea}>
          <EvilIcons name="arrow-right" size={34} color="white" style={{marginTop:-40,marginLeft:250}}/>
          </TouchableOpacity>
